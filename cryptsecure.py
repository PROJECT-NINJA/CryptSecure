...
#Main Window
main_window = Tk()
main_window.title("SecureCrypt - Rishita")
...
#Encrypt Tab
tablbl2 = Label(tab2, text= 'First generate a Key from file menu.\n\n Then enter some text in the text field below.\nPress \"Encrypt\" to encrypt the text.', font=("Corbel Bold", 12))
...
#Title at the bottom
lbl = Label(main_window, text="SHA256 Encrypter-Decrypter\n Rishita 🌸", font=("Corbel Bold", 16))
